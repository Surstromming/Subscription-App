      ...
      <div>
        ...
        <div className="container">
          <div className="summary">
            <p>Thanks for creating a Bloomon subscription <strong>{this.state.chosenName}</strong>, your first bouquet will be delivered on <strong>{startDate}</strong>.</p>
            <p>Just <strong>{nights}</strong> nights of sleep left...</p>
            <p>After that you will receive our beautiful bouquets every <strong>{this.state.chosenFrequencyId}</strong> weeks on <strong>{parseWeekday(this.state.chosenMomentId)}</strong>.</p>
          </div>
        </div>
      </div>
    );
